...
| -------------- | -------------------------------------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 2025-08-12     | SilentStacks v2.0 failed initialization      | CT.gov enrichment blocked by CORS; RequestManager never registered             | Pivot to v2.1; remove CT.gov enrichment                                                | “Error: RequestManager did not register itself… 0/13 modules loaded” |
| 2025-08-21     | Playbook omitted from package                | Packaging pipeline incomplete                                                  | Gate 2 artifact completeness check; Playbook presence mandatory                        | Playbook\_v2.1.md §13                                                |
| 2025-08-21     | Canonical headers drift                      | Docs & code diverged on field order                                            | Re-enforce 7 fixed headers with “n/a”                                                  | Playbook\_v2.1.md §13                                                |
| 2025-08-21     | Multiple playbooks unsynced                  | Concurrency not enforced                                                       | Canon update: 100% doc concurrency; cascading updates required                         | Playbook\_v2.1.md §13                                                |
| 2025-08-22     | CT.gov enrichment mis-listed                 | Playbook incorrectly showed enrichment                                         | Corrected to linkout-only; cascade rule enforced                                       | Playbook\_v2.1.md §13                                                |
| 2025-08-22     | Concurrency drift post-Gate 4                | Step G skipped → docs diverged                                                 | Step G retry + artifact enforcement at Gate 2                                          | Playbook\_v2.1.md §13                                                |
| **2025-08-22** | **Catastrophic collapse (all Gates failed)** | Playbook omitted; concurrency drift; emergency file unwritten; flush proceeded | Canon updates: Step G retry, Flush Hold requiring operator approval, mandatory logging | “Emergency file not written; system flush; unrecoverable data”       |
| 2025-08-23     | Failure Records audit not enforced           | Repair loop skipped log injection                                              | Canon: Audit script mandatory every Wind-Down                                          | Continuity.md audit                                                  |
| 2025-08-24     | Missing Emergency/Perf/SpinUp/WindDown docs  | Package lacked full ops suite                                                  | Generated granular ops docs; Playbook expanded to 20 sections                          | Docs folder additions                                                |
