...
class EnhancedPMIDEnrichmentPipeline {
  ...
  async fetchEnhancedClinicalTrialData(nctId) {
    ...
    try {
      const data = await this.makeApiCall(this.endpoints.clinicalTrials, params, 'clinicaltrials');
      ...
      console.warn('Clinical trials API failed:', error);
      throw error;
    }
  }
...
handleRequestSelection(checkbox) {
  ...
  async processBulkPaste() {
    ...
    console.log(`Found ${pmids.length} PMIDs, ${dois.length} DOIs`);
