// Complete SilentStacks App.js with All Critical Fixes Applied
(() => {
  // === Constants & State ===
  ...
  function init() {
    ...
    console.log('SilentStacks v1.1 initialized with', requests.length, 'requests');
